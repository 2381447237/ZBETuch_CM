...
public class QuestionNaireAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            mHolder.questionnaire_number = (TextView) view.findViewById(R.id.tv_questionnair_number);
            view.setTag(mHolder);
        }else {
        ...
        mHolder.questionnaire_number.setText(questionBean.getSurveyNum()+"");
        if (i % 2 == 0){
    ...
    class ViewHolder {
        ...
        TextView questionnaire_num;//编号
        TextView questionnaire_time;
        TextView questionnaire_number;//数量
    }
